...
`revalidate` แบบ time-based ตั้งนาฬิกาความ stale ส่วน `revalidateTag` / `revalidatePath` แบบ on-demand invalidate ตาม event ทั้งคู่เคลียร์ **Data Cache** และ **Full Route Cache** ที่ขึ้นกับ data นั้น ดังนั้น tag fetch ไว้เพื่อ revalidate ให้แม่นยำ
</Callout>
